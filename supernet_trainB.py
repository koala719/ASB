...
from supernet_engineB import train_one_epoch, evaluate
...
def get_args_parser():
    ...
    # config file
    parser.add_argument('--cfg',default='/home/user/lnn/AutoFormer/experiments/supernet/supernet-T.yaml', help='experiment configure file name',required=False,type=str)
    ...
    # Model parameters
    parser.add_argument('--model', default='super', type=str, metavar='MODEL',
                        help='Name of model to train')
    # AutoFormer config
    ...
    parser.add_argument('--no-repeated-aug', action='store_true', dest='repeated_aug')
    ...
    parser.add_argument('--output_dir', default='./outB/',
    ...
    parser.add_argument('--dist_url', default='tcp://localhost:55455', help='url used to set up distributed training')
...
def main(args):
    ...
    if args.mode == 'retrain' and "RETRAIN" in cfg:
        retrain_config = {'layer_num': cfg.RETRAIN.DEPTH, 'embed_dim': [cfg.RETRAIN.EMBED_DIM]*cfg.RETRAIN.DEPTH,
                          'num_heads': cfg.RETRAIN.NUM_HEADS,'mlp_ratio': cfg.RETRAIN.MLP_RATIO, 'broad': cfg.RETRAIN.BROAD}
    if args.eval:
